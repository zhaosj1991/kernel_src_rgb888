...
// 	{0x0306, 0x7359}, // PLL_MULTIPLIER
 	...
 	{0x300C, 0x0BB8}, // LINE_LENGTH_PCK_    3000
...
static const ar0521_reg mode_1280x720_120fps[] = {
	{AR0521_TABLE_WAIT_MS, AR0521_WAIT_MS},
...
static const ar0521_reg mode_2592x1944_HDR_24fps[] = {
	{AR0521_TABLE_WAIT_MS, AR0521_WAIT_MS},
	{0x0100, 0x00},/* Including sw reset */
	{0x0103, 0x01},
	{0x3001, 0x0a},
...
static const ar0521_reg mode_1920x1080_HDR_30fps[] = {
	{AR0521_TABLE_WAIT_MS, AR0521_WAIT_MS},
	{0x0100, 0x00},/* Including sw reset */
	{0x0103, 0x01},
	{0x3001, 0x0a},
...
static const ar0521_reg mode_1280x720_HDR_60fps[] = {
	{AR0521_TABLE_WAIT_MS, AR0521_WAIT_MS},
	{0x0100, 0x00},/* Including sw reset */
	{0x0103, 0x01},
	{0x3001, 0x0a},
...
static const ar0521_reg mode_2592x1944_one_lane_15fps[] = {
	{0x0100, 0x00},/* Including sw reset */
	{0x0103, 0x01},
	{0x3001, 0x0a},
	{0x3002, 0x80},
...
enum {
	...
	AR0521_MODE_1280X720_120FPS,
	AR0521_MODE_2592X1944_HDR,
	AR0521_MODE_1920X1080_HDR,
	AR0521_MODE_2592x1944_15FPS,
...
static const ar0521_reg *mode_table[] = {
	...
	[AR0521_MODE_1280X720_120FPS]		= mode_1280x720_120fps,
	[AR0521_MODE_2592X1944_HDR]		= mode_2592x1944_HDR_24fps,
	[AR0521_MODE_1920X1080_HDR]		= mode_1920x1080_HDR_30fps,
	[AR0521_MODE_2592x1944_15FPS]		= mode_2592x1944_one_lane_15fps,
...
static const struct camera_common_frmfmt ar0521_frmfmt[] = {
	...
	{{1280, 720},	ar0521_120fps,	1, 0,	AR0521_MODE_1280X720_120FPS},
	{{2600, 1952},	ar0521_30fps,	1, 0,	AR0521_MODE_2600X1952_30FPS},
	{{2592, 1944},	ar0521_24fps,	1, 1,	AR0521_MODE_2592X1944_HDR},
	{{1920, 1080},	ar0521_30fps,	1, 1,	AR0521_MODE_1920X1080_HDR},
	{{2592, 1944},	ar0521_15fps,	1, 1,	AR0521_MODE_2592x1944_15FPS},
};
